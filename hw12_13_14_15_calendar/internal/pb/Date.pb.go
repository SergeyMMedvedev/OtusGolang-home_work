...
var file_Date_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x44, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x42, 0x0a, 0x04,
	...
	0x22, 0x31, 0x0a, 0x05, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x12, 0x12, 0x0a, 0x04, 0x79, 0x65, 0x61,
	...
	0x6e, 0x74, 0x68, 0x42, 0x0d, 0x5a, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f,
...
func file_Date_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Date_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Month); i {
			case 0:
				return &v.state
			case 1:
